<template>
    <div class="mx-auto max-w-2xl">
        <h2 class="mb-4 text-xl font-bold text-gray-900 dark:text-white">Add a new friend</h2>
        <form @submit.prevent="submitForm" enctype="multipart/form-data">
            <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                ...
                <div class="sm:col-span-2">
                    <label for="introduction_content" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Introduction</label>
                    <textarea 
            ...
            <div class="mt-5">
                <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white" for="friend_avatar">Upload file</label>
                <input 
                ...
                >
                <div class="mt-1 text-sm text-gray-500 dark:text-gray-300" id="friend_avatar_help">Upload Picture of New Friend</div>
            </div>
            <button 
                type="submit" 
