        ...
        <div class="relative">
            <div class="flex overflow-x-auto pb-6 gap-6 snap-x">
                <div v-for="event in currentEvents" :key="event.id" 
                    ...
                    <div class="bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-900 dark:border-gray-700 transform transition-all duration-300 hover:scale-105">
