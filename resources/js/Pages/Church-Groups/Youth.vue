                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                                    ...
                                    <div class="relative overflow-hidden rounded-lg">
                                        ...
                                        <div class="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                            <div class="absolute bottom-0 left-0 right-0 p-4">
                                                <p class="text-white text-sm">Christopher's Description</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="mt-4 text-center">
                                        <h3 class="text-xl font-bold text-gray-900">Christopher Magalang</h3>
                                ...
                                <div class="group">
                                    <div class="relative overflow-hidden rounded-lg">
                                        ...
                                        <div class="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                            <div class="absolute bottom-0 left-0 right-0 p-4">
                                                <p class="text-white text-sm">Angelo's Description</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="mt-4 text-center">
                                        <h3 class="text-xl font-bold text-gray-900">Angelo Asanion</h3>
                                ...
                                <div class="group">
                                    <div class="relative overflow-hidden rounded-lg">
                                        ...
                                        <div class="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                            <div class="absolute bottom-0 left-0 right-0 p-4">
                                                <p class="text-white text-sm">Jeanette's Description</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="mt-4 text-center">
                                        <h3 class="text-xl font-bold text-gray-900">Jeanette Ubat</h3>
                                ...
                                <div class="group">
                                    <div class="relative overflow-hidden rounded-lg">
                                        ...
                                        <div class="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                            <div class="absolute bottom-0 left-0 right-0 p-4">
                                                <p class="text-white text-sm">Izzykiel's Description</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="mt-4 text-center">
                                        <h3 class="text-xl font-bold text-gray-900">Izzykiel Dela Cruz</h3>
