                    ...
                    <div class="flex items-center justify-center py-4 md:py-8 flex-wrap">
                        <button 
                            ...
                            :class="[
                                ...
                                selectedCategory === 'all' ? 'bg-blue-700 text-white' : 'bg-white text-blue-700 hover:text-white'
                            ]"
                        >
                            All Photos
                        </button>
                        ...
                        <button 
                            ...
                            :class="[
                                'border border-blue-600 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-full text-base font-medium px-5 py-2.5 text-center me-3 mb-3', 
                                selectedCategory === 'sportsFest' ? 'bg-blue-700 text-white' : 'bg-white text-blue-700 hover:text-white'
                            ]"
                        >
                            Sports Fest Photos
                        </button>
                        ...
                        <button 
                            ...
                            :class="[
                                'border border-blue-600 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-full text-base font-medium px-5 py-2.5 text-center me-3 mb-3', 
                                selectedCategory === 'danceCompetition' ? 'bg-blue-700 text-white' : 'bg-white text-blue-700 hover:text-white'
                            ]"
                        >
                        ...
                        <button 
                            ...
                            :class="[
                                'border border-blue-600 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-full text-base font-medium px-5 py-2.5 text-center me-3 mb-3',  
                                selectedCategory === 'churchGroups' ? 'bg-blue-700 text-white' : 'bg-white text-blue-700 hover:text-white'
                            ]"
                        >
                            Per Groups Photos
                        </button>
